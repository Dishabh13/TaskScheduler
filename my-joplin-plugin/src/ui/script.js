  ...
  function updateMembersPreview() {
    ...
    box.innerHTML = currentTeamMembers
      .map(
        m =>
          `<span class="member-tag">${m} <span onclick="removeMember('${m}')" style="cursor:pointer;color:#f44336;margin-left:5px;">×</span></span>`
      )
      .join('');
  }
  ...
  document.getElementById("create-team-form").addEventListener("submit", e => {
    ...
    renderDashboard();
    renderTaskForm();
    renderTasksByTeam(); // IMPORTANT FIX
  ...
  function renderDashboard() {
            ...
            <div class="card dashboard-team-card">
              <div>
                ...
                <div class="team-members-list">
                  ${t.members
                    .slice(0, 3)
                    .map(m => `<span class="member-tag">${m}</span>`)
                    .join("")}
    ...
    document.getElementById("todo-count").textContent =
      statusGroups.todo.length;
    document.getElementById("progress-count").textContent =
      statusGroups.inprogress.length;
          ...
          ? statusGroups[status]
            ...
            <div class="card status-${status}">
              ...
              <div>
                ...
                <span class="badge deadline">${new Date(
                  t.deadline
